...
function displayProduct(product) {
    if (!product.hasOwnProperty('imageUrl') || !product.hasOwnProperty('name') || !product.hasOwnProperty('description') || !product.hasOwnProperty('price')) {
        return;
    }
    ...
    `;
     ...
     // Création d'une fonction pour afficher les options de lentilles
